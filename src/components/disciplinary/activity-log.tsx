...
export function DisciplinaryActivityLog({ disciplinaryCase }: ActivityLogProps) {
  ...
  activities.push({
    id: "created",
    type: "created",
    date: new Date(disciplinaryCase.createdAt),
    title: "Case created",
    user: disciplinaryCase.createdBy.name,
  });

  // Step activities
  disciplinaryCase.steps.forEach((step) => {
    if (step.completedAt) {
      activities.push({
  ...
  // Notes
  disciplinaryCase.notes.forEach((note) => {
    activities.push({
      id: `note-${note.id}`,
      type: "note",
  ...
  disciplinaryCase.messages.forEach((message) => {
    activities.push({
  ...
  // Documents
  disciplinaryCase.documents.forEach((doc) => {
    activities.push({
      id: `doc-${doc.id}`,
      type: "document",
